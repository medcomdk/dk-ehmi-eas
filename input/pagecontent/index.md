...
<br/>
    ...
    For every request, EAS will either produce 
    - a concrete result response bundled as in normal FHIR server searches 
    - or an OperationOutcome that outlines whether it was a failure 
    - or an OperationOutcome containing an informative note, stating what could be the possible cause, why nothing was returned.
