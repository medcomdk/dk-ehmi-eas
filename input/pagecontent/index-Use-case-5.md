...
<img src="./3_5_getReceiverData_2_getReceivingOrganizationByMessageType&PostalCode.png" alt="3_5_getReceiverData_2_getReceivingOrganizationByMessageType&PostalCode" style="width:100%;height:auto;border=1;margin: 20px 20px 20px 0px">
