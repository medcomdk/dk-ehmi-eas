Instance: eas.getReceiverData-getReceiverDatabySORId
InstanceOf: OperationDefinition
Description: "EAS getReceiverDatabySORId"
Usage: #definition
* url = "http://easbase.eas.dk/OperationDefinition/getReceiverDatabySORId"
* version = "0.1.0"
* name = "EAS SikrGrp2 getReceiverDatabySORId"
* title = "EAS SikrGrp2 getReceiverDatabySORId"
* status = #draft
* kind = #query
...
* code = #getReceiverDatabySORId
* comment = "getReceiverDatabySORId return MedComMessagingOrganization"
