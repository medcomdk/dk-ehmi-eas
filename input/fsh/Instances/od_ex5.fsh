Instance: eas.getReceiverData-getReceiverDataByMessageTypeAndPostalCode
InstanceOf: OperationDefinition
Description: "EAS getReceiverDataByMessageType&PostalCode"
Usage: #definition
* url = "http://easbase.eas.dk/OperationDefinition/_getReceiverDataByMessageType&PostalCode"
* version = "0.1.0"
* name = "EAS getReceiverDataByMessageType&PostalCode"
* title = "EAS getReceiverDataByMessageType&PostalCode"
* status = #draft
* kind = #query
...
* code = #getReceiverDataByMessageType&PostalCode
* comment = "getReceiverDataByMessageType&PostalCode return MedComMessagingOrganization"
