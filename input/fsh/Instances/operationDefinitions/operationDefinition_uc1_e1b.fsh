...
Usage: #definition
* url = "http://medcomehmi.dk/ig/dk-ehmi-eas/OperationDefinition/eas_SikrGrp1_getReceivingOrganizationByPatientId_error1b"
* version = "0.1.0"
* name = "EAS SikrGrp1 getReceivingOrganizationByPatientId - error1b"
* title = "EAS SikrGrp1 getReceivingOrganizationByPatientId - error1b"
* status = #draft
* kind = #query
