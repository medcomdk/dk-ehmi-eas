...
Usage: #definition
* url = "http://medcomehmi.dk/ig/eas/OperationDefinition/getReceivingOrganizationByMessageTypeAndPostalCode"
* version = "0.1.0"
...
* comment = "getReceivingOrganizationByMessageTypeAndPostalCode return EasMessagingOrganization"
