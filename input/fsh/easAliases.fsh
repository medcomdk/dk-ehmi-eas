// EER Aliases
Alias: $EerMessagingOrganizationType = http://medcomehmi.dk/ig/dk-ehmi-terminology/CodeSystem/ehmi-sor-organization-type
Alias: $EerMessagingOrganizationTypeVS = http://medcomehmi.dk/ig/dk-ehmi-terminology/ValueSet/ehmi-sor-organization-type-valueset
...
Alias: $EerEndpointConnectionType = http://medcomehmi.dk/ig/dk-ehmi-terminology/CodeSystem/eer-endpoint-connection-type
...
//$EerMessagingOrganizationType
/*
Alias: $EerMessagingOrganizationType = http://medcomehmi.dk/ig/dk-ehmi-eer/CodeSystem/ehmi-sor-organization-type
Alias: $EerMessagingOrganizationTypeVS = http://medcomehmi.dk/ig/dk-ehmi-eer/ValueSet/ehmi-sor-organization-type-valueset
...
Alias: $EhmiDeliveryStatusSubTypes = http://medcomehmi.dk/ig/dk-ehmi-EAS/CodeSystem/ehmi-delivery-status-sub-types
Alias: $EhmiDeliveryStatusSubTypesVS = http://medcomehmi.dk/ig/dk-ehmi-EAS/ValueSet/EhmiDeliveryStatusSubTypesValueSet
Alias: $EhmiDeliveryStatusOutcome = http://hl7.org/fhir/audit-event-outcome
Alias: $EhmiDeliveryStatusOutcomeValueSet = http://medcomehmi.dk/ig/dk-ehmi-EAS/ValueSet/ehmi-delivery-status-outcome-valueset
Alias: $EhmiDeliveryStatusSourceType = http://medcomehmi.dk/ig/dk-ehmi-EAS/CodeSystem/ehmi-delivery-status-source-type
Alias: $EhmiDeliveryStatusSourceTypeValueSet = http://medcomehmi.dk/ig/dk-ehmi-EAS/ValueSet/EhmiDeliveryStatusSourceTypeValueSet
Alias: $EhmiDeliveryStatusParticipationRoleType = http://medcomehmi.dk/ig/dk-ehmi-EAS/CodeSystem/ehmi-delivery-status-participationroletype
Alias: $EhmiDeliveryStatusParticipationRoleTypeValueSet = http://medcomehmi.dk/ig/dk-ehmi-EAS/ValueSet/EhmiDeliveryStatusParticipationRoleTypeValueSet
Alias: $EhmiDeliveryStatusAgentWhoIdentifierTypes = http://medcomehmi.dk/ig/dk-ehmi-EAS/CodeSystem/ehmi-delivery-status-agent-who-identifier-types
Alias: $EhmiDeliveryStatusAgentWhoIdentifierTypesValueSet = http://medcomehmi.dk/ig/dk-ehmi-EAS/ValueSet/EhmiDeliveryStatusAgentWhoIdentifierTypesValueSet
Alias: $EhmiDeliveryStatusEntityType = http://medcomehmi.dk/ig/dk-ehmi-EAS/CodeSystem/ehmi-delivery-status-entity-type
Alias: $EhmiDeliveryStatusEntityTypeValueSet = http://medcomehmi.dk/ig/dk-ehmi-EAS/ValueSet/EhmiDeliveryStatusEntityTypeValueSet
Alias: $EhmiDeliveryStatusEntityDetailType = http://medcomehmi.dk/ig/dk-ehmi-EAS/CodeSystem/ehmi-delivery-status-entity-detail-type
Alias: $EhmiDeliveryStatusEntityDetailTypeValueSet = http://medcomehmi.dk/ig/dk-ehmi-EAS/ValueSet/EhmiDeliveryStatusEntityDetailTypeValueSet
Alias: $EhmiDeliveryStatusValueSet = http://medcomehmi.dk/ig/dk-ehmi-EAS/ValueSet/ehmi-delivery-status-valueSet
Alias: $EhmiDeliveryStatusEntityMessageType = http://medcomehmi.dk/ig/dk-ehmi-EAS/CodeSystem/ehmi-delivery-status-entity-message-type
*/
...
Alias: $EhmiDeliveryStatusSourceTypeValueSet = http://medcomehmi.dk/ig/dk-ehmi-terminology/ValueSet/ehmi-delivery-status-source-type-valueset
Alias: $EhmiDeliveryStatusParticipationRoleType = http://medcomehmi.dk/ig/dk-ehmi-terminology/CodeSystem/ehmi-delivery-status-participationroletype
Alias: $EhmiDeliveryStatusParticipationRoleTypeValueSet = http://medcomehmi.dk/ig/dk-ehmi-terminology/ValueSet/ehmi-delivery-status-participationroletype-valueset
Alias: $EhmiDeliveryStatusAgentWhoIdentifierTypes = http://medcomehmi.dk/ig/dk-ehmi-terminology/CodeSystem/ehmi-delivery-status-agent-who-identifier-types
Alias: $EhmiDeliveryStatusAgentWhoIdentifierTypesValueSet = http://medcomehmi.dk/ig/dk-ehmi-terminology/ValueSet/ehmi-delivery-status-agent-who-identifier-types-valueset
Alias: $EhmiDeliveryStatusEntityType = http://medcomehmi.dk/ig/dk-ehmi-terminology/CodeSystem/ehmi-delivery-status-entity-type
Alias: $EhmiDeliveryStatusEntityTypeValueSet = http://medcomehmi.dk/ig/dk-ehmi-terminology/ValueSet/ehmi-delivery-status-entity-type-valueset
Alias: $EhmiDeliveryStatusEntityDetailType = http://medcomehmi.dk/ig/dk-ehmi-terminology/CodeSystem/ehmi-delivery-status-entity-detail-type
Alias: $EhmiDeliveryStatusEntityDetailTypeValueSet = http://medcomehmi.dk/ig/dk-ehmi-terminology/ValueSet/ehmi-delivery-status-entity-detail-type-valueset
